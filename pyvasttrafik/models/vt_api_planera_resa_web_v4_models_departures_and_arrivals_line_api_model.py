...
class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineApiModel(object):
    ...
    def __init__(self, gid=None, name=None, short_name=None, designation=None, background_color=None, foreground_color=None, border_color=None, transport_mode=None, transport_sub_mode=None, is_wheelchair_accessible=None, local_vars_configuration=None):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineApiModel):
            return False
