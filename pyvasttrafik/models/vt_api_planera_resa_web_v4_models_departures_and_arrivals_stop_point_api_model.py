...
class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsStopPointApiModel(object):
    ...
    def __init__(self, gid=None, name=None, platform=None, latitude=None, longitude=None, local_vars_configuration=None):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsStopPointApiModel):
            return False
