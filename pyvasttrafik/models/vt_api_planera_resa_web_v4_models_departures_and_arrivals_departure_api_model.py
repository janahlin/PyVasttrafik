...
class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel(object):
    ...
    def __init__(self, details_reference=None, service_journey=None, stop_point=None, planned_time=None, estimated_time=None, estimated_otherwise_planned_time=None, is_cancelled=None, is_part_cancelled=None, occupancy=None, local_vars_configuration=None):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel):
            return False
