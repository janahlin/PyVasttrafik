...
class VTApiPlaneraResaCoreModelsLocationType(object):
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """VTApiPlaneraResaCoreModelsLocationType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VTApiPlaneraResaCoreModelsLocationType):
            return False
