...
class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineDetailsApiModel(object):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineDetailsApiModel):
            return False
