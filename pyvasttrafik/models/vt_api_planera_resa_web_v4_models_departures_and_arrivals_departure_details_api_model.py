...
class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureDetailsApiModel(object):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureDetailsApiModel):
            return False
